...
try:
    ...
    from intent import Loki_PublicPrivateSchool
    ...
    if lokiRst.getStatus():
        for index, key in enumerate(inputLIST):
            for resultIndex in range(0, lokiRst.getLokiLen(index)):
                ...
                # PublicPrivateSchool
                if lokiRst.getIntent(index, resultIndex) == "PublicPrivateSchool":
                    resultDICT = Loki_PublicPrivateSchool.getResult(key, lokiRst.getUtterance(index, resultIndex), lokiRst.getArgs(index, resultIndex), resultDICT)
...
if __name__ == "__main__":
    ...
    # PublicPrivateSchool
    print("[TEST] PublicPrivateSchool")
    inputLIST = ['我要找公立大學','我要找公立大學校系','我要找公立大學外文系']
    testLoki(inputLIST, ['PublicPrivateSchool'])
    print("")

    # Location
    print("[TEST] Location")
    inputLIST = ['我要找台北市外文系','我要找台北和新竹外文系']
